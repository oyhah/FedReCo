...
def args_parser():
    ...
    parser.add_argument('--lr_first', type=float, default=0.01, help="learning rate of first part")
    parser.add_argument('--lr_last', type=float, default=0.01, help="learning rate of last part")
    parser.add_argument('--lr_server', type=float, default=0.01, help="learning rate of server")
    parser.add_argument('--lambda_value', type=float, default=0.01, help="lambda value of regularization term")
    ...
    parser.add_argument('--sync', type=str, default='False', help='If the model is synchronized for FedCR')
